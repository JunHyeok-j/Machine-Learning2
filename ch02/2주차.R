...
chi_squre_test_result <- chisq.test(cross_tab)
print(chi_squre_test_result)


grow <- read.csv("C:/Users/user/Desktop/학기/3-2/머신러닝 2/2주차/cafe.csv", stringsAsFactors = TRUE)
